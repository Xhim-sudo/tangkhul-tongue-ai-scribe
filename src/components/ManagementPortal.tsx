...
import { Shield, Lock, CheckCircle, XCircle, Phone, Download, TrendingUp } from "lucide-react";
...
const ManagementPortal = () => {
  ...
  return (
    <div className="space-y-6">
      ...
      <Card className="bg-white/70 backdrop-blur-sm border-orange-200">
        <CardHeader>
          <CardTitle className="text-orange-800">Top Contributors by Accuracy</CardTitle>
        </CardHeader>
        <CardContent>
